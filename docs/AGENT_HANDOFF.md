...
Run `task validate` before handing off execution-engine changes. Also run
targeted unit, integration, contract, or platform checks when the change touches
behavior covered by those checks.
