...
- `knowledge_bank.snippets[]` with retrieved Knowledge Bank entry metadata. These snippets describe context already injected by control plane and do not grant tool permissions.
